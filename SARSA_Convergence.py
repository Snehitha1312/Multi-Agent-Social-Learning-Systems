...
plt.title('SARSA: max ΔQ vs Episodes')
plt.grid(True)
plt.tight_layout()
plt.savefig("images/sarsa_maxdelta.png", dpi=200)
...
plt.title('SARSA: V(b) convergence (representative beliefs)')
plt.legend(loc='best', fontsize='small')
plt.grid(True)
plt.tight_layout()
plt.savefig("images/sarsa_V_convergence.png", dpi=200)

print("Saved sarsa plots in images/")
